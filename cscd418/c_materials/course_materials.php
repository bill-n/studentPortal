...
<?php
$conn=new PDO('mysql:host=localhost; dbname=cscd418', 'root', '') or die(mysql_error());
...
$query=$conn->query("INSERT INTO course_materials (name,date) VALUES ('$name','$date')");
if($query){
...
#photo
{
   ...
   <div class = "row">
      ...
      <p>
         ...
         <a href="../../lecturer_view.php" class="btn btn-info btn-lg">Go back</a>
      </p>
    </div>
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<th>Remove</th>
                            ...
                            <tbody>
							<?php 
							$query=mysqli_query($conn,"select * from course_materials ORDER BY id DESC");
