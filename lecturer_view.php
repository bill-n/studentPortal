    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="assignment/assignment_upload.php">Assignment</a></li>
      ...
      <li class="dropdown">
        ...
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="cscd418/cscd418_slides/upload_index.php">Lecture slides</a></li>
          <li><a href="cscd418/assignment/assignment_upload.php">Assignment</a></li>
          <li><a href="cscd418/c_materials/course_materials.php">Course materials</a></li>
          <li><a href="cscd418/course_outline/upload_coutline.php">Course outline</a></li>
        </ul>
      </li>
    ...
    <div class="col-sm-3 sidenav">
    	...
    	<br />
         ...
         <div><a href="#" class="btn btn-default btn-lg">UPLOAd FILES FOR CSIT 408</a></div><br />
          <div>
      <p>
        <a href="slides/upload_index.php" class="btn btn-danger btn-lg">LECTURE SLIDES</a>
      </p>
    </div>
      <br />
      ...
      <div>
      <p>
         <a href="assignment/assignment_upload.php" class="btn btn-success btn-lg" role="button">ASSIGNMENT</a>
       </p>
     </div>
    <br />
     ...
     <div>
      <p>
         <a href="c_materials/course_materials.php" class="btn btn-warning btn-lg" role="button">COURSE MATERIALS</a>
       </p>
     </div>
     <br />
      ...
      <p>
       ...
       <div>
        <br />
      <p>
      <a href="https://dashboard.tawk.to/#/chat" class="btn btn-danger btn-lg" role="button">Go online</a>
       </p>
     </div>
     </div>
